...
import SegmentConfigPanel from '@/modules/design/panels/SegmentConfigPanel.vue'
import RepeaterConfigPanel from '@/modules/design/panels/RepeaterConfigPanel.vue'
